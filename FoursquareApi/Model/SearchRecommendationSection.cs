...
{
    public sealed class SearchRecommendationSection : IFoursquareType
    {
        ...
        public SearchRecommendationSection()
        {
            this.tappable = true;
        }
        ...
        public SearchRecommendationFilters activeFilters { get; set; }
        public List<SearchRecommendationItem> results { get; set; }
        ...
        public List<SearchRecommendationSection> subSuggestions { get; set; }
        public SearchRecommendationLocations.SearchRecommendationGeoBounds geoBounds { get; set; }
    }
}
